/**
 * @file interface.h
 * @author Jollu8 (zholu008@gmail.com)
 * @brief Файл интер
 * @version 0.1
 * @date 2022-12-20
 *
...
/**
 * @brief Интерфейс для работы с компонентами графического редактора
 *
 */
struct IVisitor {
...
/**
 * @brief Абстрактный класс компонентов графического редактора
 *
 */
struct Component {
 ...
 * @brief Интерфейс модели
 *
 * Интерфейс модели использует паттерн Наблюдатель через методы:
